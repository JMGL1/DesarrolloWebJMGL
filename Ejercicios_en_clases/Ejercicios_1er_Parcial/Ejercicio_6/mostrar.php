...
<head>
    <meta charset="UTF-8">
    <title>Resultado - Mostrar Datos</title>
        ...
        <div class="contenido">
            ...
            <div class="formulario-box">
                ...
                if (isset($_POST['nombre']) && isset($_POST['ciudad'])) {
                    ...
                    echo "<p>Hola <b>$nombre</b>, vives en <span style='color:red;'>$ciudad</span>.</p>";
                } else {
                    echo "<p style='color:red;'>No se recibieron los datos correctamente.</p>";
                }
                ?>
                <br>
                <a href="../Ejercicio_6/form_mostrar.html">Volver al formulario</a>
            </div>
        </div>
    </div>
</div>
