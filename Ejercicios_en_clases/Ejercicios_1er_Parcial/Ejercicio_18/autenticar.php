...
if (isset($_POST['usuario']) && isset($_POST['contrasena'])) {
    ...
    // Si entran directo, asignamos usuario normal
...
<head>
    <meta charset="UTF-8">
    <title>Resultado - Autenticar</title>
    ...
    <div class="cuerpo">
        ...
        <div class="contenido">
            ...
            <div class="formulario-box">
                <p>Valor de la variable de sesión guardada: <b><?php echo $_SESSION['usuario']; ?></b></p>
                <br>
                <a href="acceso.php" style="font-weight: bold; font-size: 18px;">Ir a la página de Acceso</a>
            </div>
        </div>
    </div>
</div>
