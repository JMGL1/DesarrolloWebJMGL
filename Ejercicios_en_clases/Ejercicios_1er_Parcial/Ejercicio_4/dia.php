        ...
        <div class="contenido">
            ...
            <div class="formulario-box">
                ...
                if (isset($_GET['n'])) {
                    ...
                    echo "<label for='diaSelect'>Día de la semana seleccionado:</label><br>";
                    echo "<select id='diaSelect'>";
                    for ($i = 1; $i <= 7; $i++) {
                    ...
                    echo "<p style='color:red;'>No se recibió el número del día.</p>";
                }
                ?>
                <br><br>
                <a href="../Ejercicio_4/form_dia.html">Volver al formulario</a>
            </div>
        </div>
    </div>
</div>
