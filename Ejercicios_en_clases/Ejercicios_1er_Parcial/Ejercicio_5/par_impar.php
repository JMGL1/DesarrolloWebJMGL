            ...
            <div class="formulario-box">
                ...
                if (isset($_POST['numero'])) {
                    ...
                    if (is_numeric($numero) && $numero > 0) {
                        if ($numero % 2 == 0) {
                            echo "<h3>El número <b>$numero</b> es <span style='color:blue;'>PAR</span>.</h3>";
                        } else {
                            echo "<h3>El número <b>$numero</b> es <span style='color:green;'>IMPAR</span>.</h3>";
                        }
                    } else {
                        echo "<p style='color:red;'>Por favor, introduzca un número entero positivo válido.</p>";
                    }
                } else {
                    echo "<p style='color:red;'>No se recibió ningún número.</p>";
                }
                ?>
                <br>
                <a href="../Ejercicio_5/form_par_impar.html">Volver al formulario</a>
            </div>
        </div>
    </div>
</div>
