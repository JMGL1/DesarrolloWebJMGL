            ...
            <div class="formulario-box">
                ...
                if (isset($_GET['b']) && isset($_GET['h'])) {
                    ...
                    if (is_numeric($b) && is_numeric($h)) {
                        $a = ($b * $h) / 2;
                        echo "<p>La base introducida es: <b>$b</b></p>";
                        echo "<p>La altura introducida es: <b>$h</b></p>";
                        echo "<h3>El área del triángulo es: <b>$a</b></h3>";
                    } else {
                        echo "<p style='color:red;'>Por favor, introduzca valores numéricos válidos.</p>";
                    }
                } else {
                ...
                ?>
                <br>
                <a href="../Ejercicio_3/form_area.html">Volver al formulario</a>
            </div>
        </div>
    </div>
</div>
